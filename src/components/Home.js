...
export default function Home() {
    return (
        <div>
            ...
            <h3><a href='https://degroot12.github.io/Super-Max' target='_blank'>Super-Max</a></h3>
            ...
            <div className='game-summary'>
            <h3><a href='https://click-n-meal.herokuapp.com' target='_blank'>Click-n-Meal</a></h3>
            ...
            <div className='game-summary'>
                <h3><a href='https://band-square.herokuapp.com/' target='_blank'>Band-Square</a></h3>
