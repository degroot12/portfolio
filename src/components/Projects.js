    ...
    return (
        <div>
            ...
            <p>Click-n-Meal is an easy way to find the recipes to your liking. You can filter the recipes 
                ...
                You can also add you own recipes to the database</p><p><a href='https://click-n-meal.herokuapp.com' target='_blank'>Show me the app</a></p>
            </div>
            <div className='game-summary'>
                <h3>Band-Square</h3>
                ...
                <p>Band-Square is a platform where musicians can connect with other muscians. 
                   ...
                   <p><a href='https://band-square.herokuapp.com/' target='_blank'>Show me the app</a></p>
            </div>
        </div>
    )
}
